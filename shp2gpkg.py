...
PARSER.add_argument('--output', type=str, default='geo-model.gpkg', nargs='?', help='output filename')
PARSER.add_argument('--search', type=str, default='.', nargs='?', help='search path')
PARSER.add_argument('--crs', type=str, default='EPSG:32630', nargs='?', help='coordinate reference system')
